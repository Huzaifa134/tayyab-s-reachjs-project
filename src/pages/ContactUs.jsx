                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div className="mb-4">
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Your Queries</p>
                        </div>
                    </div>
                    <div className="flex items-stretch justify-center">
                        <div className="grid md:grid-cols-2">
                                ...
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Gulshan-E-Iqbal</p>
                                            <p className="text-gray-600 dark:text-slate-400">Karachi, Pakistan</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-700 text-gray-50">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Mobile: +92 12313  8 </p>
                                            <p className="text-gray-600 dark:text-slate-400">Mail: dtect@gmail.com</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-700 text-gray-50">
                            ...
                            <div className="card h-fit max-w-6x1 p-5 md:p-12" id="form">
                                ...
                                <form id="contactForm">
                                    ...
                                    <div className="text-center">
                                        <button type="submit" className="w-full bg-blue-700 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                                    </div>
                                </form>
                            </div>
                        </div>
