                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <Link to={"/marketing"} className="ml-1 text-sm font-medium breadcrumbs-p text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Marketing</Link>
                        </div>
                    </li>
                </ol>
            </nav>
