                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div className="flex items-center">
                                ...
                                <Link to={"/hosting/business-hosting"} className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Business Hosting</Link>
                            </div>
                        </li>
                    </ol>
                </nav>
